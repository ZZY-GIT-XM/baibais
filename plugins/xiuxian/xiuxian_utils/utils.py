...
class Txt2Img:
    ...
    async def save(self, title, lrc):
        ...
        out_img = Image.new(mode="RGB", size=(w, h), color=(255, 100, 180))
...
def number_to(num):
    ...
    units = [
        ...
        '宇宙尘埃数', '灵魂数', '智慧数', '命运轨迹数', '小天帝', '万小天帝', '亿小天帝', '兆小天帝', '京小天帝',
        '垓小天帝', '秭小天帝', '穰小天帝', '沟小天帝', '涧小天帝', '正小天帝', '载小天帝', '极小天帝',
        '恒河沙小天帝', '阿僧祗小天帝', '那由他小天帝', '不思议小天帝', '无量大小天帝', '万无量大小天帝', '天帝', '万天帝', '亿天帝', '兆天帝', '京天帝',
        '垓天帝', '秭天帝', '穰天帝', '沟天帝', '涧天帝', '正天帝', '载天帝', '极天帝',
        '恒河沙天帝', '阿僧祗天帝', '那由他天帝', '不思议天帝', '无量大天帝', '万无量大天帝', '大天帝', '万大天帝', '亿大天帝', '兆大天帝', '京大天帝',
        '垓大天帝', '秭大天帝', '穰大天帝', '沟大天帝', '涧大天帝', '正大天帝', '载大天帝', '极大天帝',
        '恒河沙大天帝', '阿僧祗大天帝', '那由他大天帝', '不思议大天帝', '无量大大天帝', '万无量大大天帝'
    ]
