...
auction_view = on_command("我是大玩家拍卖品查看", aliases={"我是大玩家查看拍卖品"}, priority=8, permission=GROUP,
                          block=True)
auction_withdraw = on_command("我是大玩家撤回拍卖品", aliases={"我是大玩家拍卖品撤回"}, priority=10, permission=GROUP,
                              block=True)
offer_auction = on_command("我是大玩家拍卖", priority=5, permission=GROUP, block=True)
auction_added = on_command("我是大玩家提交拍卖品", aliases={"我是大玩家拍卖品提交"}, priority=10, permission=GROUP,
                           block=True)
